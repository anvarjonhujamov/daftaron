...
export default function CustomerDetailPage() {
    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-900 min-h-screen pb-24 transition-colors">
            ...
            <div className="bg-white dark:bg-gray-800 pt-0.5 pb-4 rounded-b-[24px] shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] dark:shadow-none border-b border-gray-100 dark:border-gray-700/50 transition-all">
                {/* Toolbar */}
                ...
                <div className="flex flex-col items-center text-center px-6">
                    <h1 className="text-[18px] font-bold text-gray-900 dark:text-white mb-0 leading-tight">
                        {customer.name}
                    </h1>
                    ...
                    <div className={`text-[28px] font-extrabold tracking-tight mb-2 ${totalDebt > 0 ? 'text-red-500' : 'text-green-500'}`}>
                        {formatCurrency(totalDebt)} <span className="text-[13px] font-bold opacity-70">so'm</span>
                    </div>

                    <div className={`inline-flex items-center px-3 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-widest ${
                        totalDebt > 0 
