...
export default function SubscriptionPage() {
    ...
    const mockPlans = [
        ...
        },
        {
            ...
            features: [
                ...
                "3 ta xodim",
                "50 ta bepul SMS",
                "Qo'shimcha do'kon, xodim va SMS paketlari",
                "Qo'shimcha do'kon 14 000 so'm",
                "Qo'shimcha xodim 9 000 so'm",
                "Qo'shimcha har bir SMS 190 so'm",
    ...
    const activePlan = plans.find((p) => String(p.id) === String(activePlanId))
                ...
                {plans.length === 0 ? (
                    ...
                    <div className="space-y-2">
                        {plans.map((plan) => {
                            ...
                            const isActivePlan = activePlanId && String(activePlanId) === String(plan.id) && isSubscriptionActive
